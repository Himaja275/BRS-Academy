...
export default function App() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await emailjs.sendForm("service_sde8vwb", "template_mfghpdr", form.current, {
        publicKey: "D7YMmoFGluB0x3r8c",
      });
  ...
  return (
    <div className="bg-[#ffffffb3] rounded-2xl p-8 font-[Outfit] font-medium heading text-[#334155]">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" ref={form}>
        {/* Student Name */}
        <div>
        ...
        <button
          ...
          className={`w-full py-2 rounded-lg font-semibold transition-opacity nml-text text-white flex items-center justify-center ${isSubmitting
